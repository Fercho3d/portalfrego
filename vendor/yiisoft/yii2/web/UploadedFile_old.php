...
class UploadedFile extends BaseObject
{
    ...
    public static function getInstanceFromMultiple($modelName,$attribute){

       //echo $modelName;
       //echo $_FILES[$modelName]['name']['pdf_attach_file'];
       //exit();

        return new static([

            'name' => $_FILES[$modelName]['name'][$attribute], 
            'type' => $_FILES[$modelName]['type'][$attribute], 
            'tempName' => $_FILES[$modelName]['tmp_name'][$attribute], 
            'error' => $_FILES[$modelName]['error'][$attribute], 
            'size' => $_FILES[$modelName]['size'][$attribute], 
